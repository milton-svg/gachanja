...
//    val houseViewModel: HouseViewModel = viewModel()
//
//    // Firebase reference using passed-in houseId
//    val currentDataRef = FirebaseDatabase.getInstance().getReference("Houses/$houseId")
//
//    // Fetch house data from Firebase
//    DisposableEffect(houseId) {
//        val listener = object : ValueEventListener {
//            override fun onDataChange(snapshot: DataSnapshot) {
//                val house = snapshot.getValue(HouseModel::class.java)
//                house?.let {
...
//        ) {
//            Button(onClick = {
//                navController.popBackStack() // Navigate back to house list
//            }) {
//                Text(text = "All houses")
//            }
//
...
fun UpdatehouseScreen(navController: NavController, houseId: String) {
    ...
    Column(
        ...
        OutlinedTextField(
            value = houseprice,
            onValueChange = { houseprice = it },
            label = { Text("Unit house Price") },
            placeholder = { Text("Please enter unit house price") },
            modifier = Modifier.fillMaxWidth()
        )
